...
if __name__ == '__main__':
    ...
    # Model selection
    parser.add_argument('--model', default="lmanet.py")
    ...
    parser.add_argument('--train-erfnet-shallow-dec', action='store_true')
    parser.add_argument('--shallow-dec', action='store_true')
    ...
    parser.add_argument('--local-correlation', action='store_true', default=True)
